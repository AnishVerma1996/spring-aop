...
<td>Usename</tr><td><spring:input path="uname" /><spring:errors path="uname"/></td>
</tr>
<tr>
...
<spring:radiobutton path="gender" value="FEMALE" label="Femael"/></td><td>
<spring:errors path="gender"/> </td>
</tr>
<tr>


<td>Birth Day(MM/dd/yyyy)</td><td><spring:input path="birthDay"/></td><td><spring:errors path="birthDay"/></td>
</tr>
<tr>
